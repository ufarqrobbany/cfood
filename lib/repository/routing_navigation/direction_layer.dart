...
import 'package:cfood/repository/routing_navigation/osrm_route_response.dart';
  ...
  void _getDirections() async {
    ...
    try {
      response = await http.get(
          Uri.parse('https://router.project-osrm.org/route/v1/${widget.type}/$destinations?overview=full&geometries=geojson')
      );
