...
class _SearchScreenState extends State<SearchScreen> {
  ...
  final List<String> riwayat = [
      'ayam geprek', 'tahu', 'nasi padang', 'gehu', 'es krim', 'martabak'
    ];
  final List<String> pencarianPopuler = [
      'gehu', 'es krim', 'martabak', 'ayam geprek', 'tahu', 'nasi padang', 
  ];

  final List<String> listSearcMenu = [
      'gehu', 'es krim', 'martabak', 'ayam geprek', 'tahu', 'nasi padang', 'nasi goreng', 'roti bakar', 'cimol', 'cilok'
  ];
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          ...
          preferredSize: searchDone ? const Size.fromHeight(130) : const Size.fromHeight(80),
          child: Column(
    ...
    return Column(
      ...
      children: [
        const Padding(
            ...
            child: Text('Hasil Pencarian', style: AppTextStyles.subTitle,),
            ),
            Padding(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(
            padding: EdgeInsets.symmetric(horizontal: 25, vertical: 20),
            child: Text('Riwayat', style: AppTextStyles.subTitle,),
            ),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              child: Wrap(
            ...
            const Padding(
            padding: EdgeInsets.symmetric(horizontal: 25, vertical: 20),
            child: Text('Pencarian Populer', style: AppTextStyles.subTitle,),
            ),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              child: Wrap(
  ...
  Widget searchItemBox({VoidCallback? onPressed, String? text, }) {
