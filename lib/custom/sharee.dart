...
Map<String, String> randomDataMap = {
  ...
  void onTapOpenShareOption(
    ...
    barrierDismissible: true,
        ...
        yesText: 'Copy Link',
        noText: 'Opsi Lain',
        colorYes: Warna.kuning,
        colorNO: Warna.kuning, onTapYes: () {
